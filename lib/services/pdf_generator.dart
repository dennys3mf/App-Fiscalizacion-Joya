...
class PdfGenerator {
  ...
  static const PdfColor rojoMuni = PdfColor.fromInt(0xffD32F2F); // Un rojo similar al del logo
  static const PdfColor doradoMuni = PdfColor.fromInt(0xffFBC02D); // Un dorado/amarillo similar
  ...
  static Future<Uint8List> generateBoletaPdf(Map<String, dynamic> data, {
    ...
    String gerenciaNombre = 'GERENCIA DE TRANSPORTE'
  }) async {
            ...
            children: [
                    ...
                    pw.Expanded(
                      child: pw.Column(
                        ...
                        children: [
                          ...
                          pw.Divider(color: doradoMuni, height: 10, thickness: 2),
                          pw.Text(
              ...
              pw.Align(
                ...
                child: pw.Text(
                  ...
                  style: pw.TextStyle(fontWeight: pw.FontWeight.bold, color: PdfColors.grey800),
                ),
              ),
              ...
              pw.Center(child: pw.Text('Escanee para verificar boleta', style: const pw.TextStyle(color: PdfColors.grey600, fontSize: 10))),
            ],
          );
        },
      ),
    ...
    return pw.Padding(
      ...
      child: pw.Row(
        ...
        children: [
          pw.SizedBox(
            width: 120,
            child: pw.Text(title, style: pw.TextStyle(fontWeight: pw.FontWeight.bold, color: PdfColors.grey700)),
          ),
          pw.Expanded(
            child: pw.Text(value),
          ),
